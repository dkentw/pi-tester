...
testParameter = {
                 'TEST_HOST': "apt-websrv-sjdc.trendmicro.com",
                 'TEST_PORT': 80,
                 'PROTOCOL_VER': '1',
...
class APT0101:
    def __init__(self):
        self.url = 'apt-websrv-iad1.trendmicro.com'
        self.port = ''
        self.message = ''    
...
class APT0104:
    def __init__(self):
        ...
        self.pattern = r'{"dbg_info": {"user_cache_info": "positive hit", "cache_info": "not hit"}, "uid_list": [{"_id": "621c7466d2728b91375d8b06965a39e77e03a06f"}]}'
    def run(self):
        result = TestLib.APTQuery(self.testParameter)
        print result
        return True if result == self.pattern else False
...
class APT0105:
    def __init__(self):
        ...
        self.pattern = r'{"dbg_info": {"user_cache_info": "positive hit", "cache_info": "not hit"}, "uid_list": [{"_id": "f89a2997e8742b051cda853110bfb0c228b6ab36"}]}'
    def run(self):
        result = TestLib.APTQuery(self.testParameter)
        print result
        return True if result == self.pattern else False
